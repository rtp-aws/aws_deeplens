...
; _"<Image>/Tools/Arrow..."                             ; menu label
(script-fu-register 
  "script-fu-draw-arrow"                                 ; func name
  "Arrow..."                                            ; menu label
  "Draw a nearly arbitrary arrow in your image" ; description
  "Berengar W. Lehr <B-Ranger@web.de>"                   ; author
  "2009, Berengar W. Lehr / MPG@IDIR, UH Jena, Germany."
  "19th November 2009"                             ; copyright
  "*"
