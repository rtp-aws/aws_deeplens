...
# original bucket_name = "REPLACE-WITH-NAME-OF-YOUR-S3-BUCKET"
bucket_name = "davisjf-worker-safety"
...
def push_to_s3(img):
    try:
        ...
        # NOTE: JFD Look this up in api refference. Is the bucket an arn on string?
